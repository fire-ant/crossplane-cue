package database_azure_crossplane_io_postgresqlservers

customresourcedefinition: "postgresqlservers.database.azure.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "A PostgreSQLServer is a managed resource that represents an Azure PostgreSQL Database Server."
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "SQLServerParameters define the desired state of an Azure SQL Database, either PostgreSQL or MySQL."
								...
								properties: {
									...
									sku: {
										...
										properties: {
											...
											tier: {
												description: "Tier - The tier of the particular SKU. Possible values include: 'Basic', 'GeneralPurpose', 'MemoryOptimized'"
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "SQLServerObservation represents the current state of Azure SQL resource."
