package database_azure_crossplane_io_mysqlservers

customresourcedefinition: "mysqlservers.database.azure.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "A MySQLServer is a managed resource that represents an Azure MySQL Database Server."
