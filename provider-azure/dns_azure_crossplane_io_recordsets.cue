package dns_azure_crossplane_io_recordsets

customresourcedefinition: "recordsets.dns.azure.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "A RecordSet is a managed resource that represents an Azure DNS RecordSet"
						...
						properties: {
							...
							forProvider: {
								...
								properties: {
									...
									zoneName: {
										description: "ZoneName specifies the name of the Zone that should contain this DNS RecordSet."

										type: "string"
									}
									zoneNameRef: {
										description: "ZoneNameRef - A reference to a Zone object to retrieve its name"
									...
									zoneNameSelector: {
										description: "ZoneNameSelector - A selector for a Zone object to retrieve its name"
