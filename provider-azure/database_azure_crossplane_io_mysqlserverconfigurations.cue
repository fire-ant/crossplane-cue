package database_azure_crossplane_io_mysqlserverconfigurations

customresourcedefinition: "mysqlserverconfigurations.database.azure.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "A MySQLServerConfiguration is a managed resource that represents an Azure MySQL Server Configuration."
