package registry_gcp_crossplane_io_containerregistries

customresourcedefinition: "containerregistries.registry.gcp.crossplane.io": {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "ContainerRegistryParameters define the desired state of a ContainerRegistry"

								properties: location: {
									description: "The location of the registry. Possible Values: ASIA, EU, US"
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "ContainerRegistryObservation is used to show the observed state of the ContainerRegistry"
