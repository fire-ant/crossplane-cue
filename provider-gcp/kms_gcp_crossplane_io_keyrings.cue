package kms_gcp_crossplane_io_keyrings

customresourcedefinition: "keyrings.kms.gcp.crossplane.io": {
			...
			schema: openAPIV3Schema: {
				...
				properties: {
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "KeyRingObservation is used to show the observed state of the KeyRing resource on GCP. All fields in this structure should only be populated from GCP responses; any changes made to the k8s resource outside of the crossplane gcp controller will be ignored and overwritten."

								properties: {
									createTime: {
										description: "CreateTime: Output only. The time at which this KeyRing was created."

										type: "string"
									}
									name: {
										description: "Name: Output only. The resource name for the KeyRing in the format `projects/*/locations/*/keyRings/*`."
