package compute_gcp_crossplane_io_routers

customresourcedefinition: "routers.compute.gcp.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "A Router is a managed resource that represents a Google Compute Engine Router"
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "RouterParameters define the desired state of a Google Compute Engine Router. Most fields map directly to a Router: https://cloud.google.com/compute/docs/reference/rest/v1/routers/"
		...
		"""
											...
											advertisedIpRanges: {
												...
												items: {
													description: "A RouterAdvertisedIpRange represents the IP ranges advertised by router."
									...
									bgpPeers: {
										...
										items: {
											description: "A RouterBgpPeer represents the BgpPeer configuration for the router."
		...
		"""
									...
									encryptedInterconnectRouter: {
										description: "EncryptedInterconnectRouter: Field to indicate if a router is dedicated to use with encrypted Interconnect Attachment (IPsec-encrypted Cloud Interconnect feature). Not currently available in all Interconnect locations."
									...
									interfaces: {
										...
										items: {
											description: "A RouterInterface represent the Interface information for router."
											...
											properties: {
												...
												linkedInterconnectAttachment: {
													description: "LinkedInterconnectAttachment: URI of the linked Interconnect attachment. It must be in the same region as the router. Each interface can have one linked resource, which can be a VPN tunnel, an Interconnect attachment, or a virtual machine instance."

													type: "string"
												}
												linkedVpnTunnel: {
													description: "LinkedVpnTunnel: URI of the linked VPN tunnel, which must be in the same region as the router. Each interface can have one linked resource, which can be a VPN tunnel, an Interconnect attachment, or a virtual machine instance."
									...
									nats: {
										...
										items: {
											...
											properties: {
												...
												enableEndpointIndependentMapping: type: "boolean"
												icmpIdleTimeoutSec: {
		...
		"""
												...
												subnetworks: {
													...
													items: {
														description: "A RouterNatSubnetworkToNat represent the Subnetwork information for Router Nat Service."
		...
		"""
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "A RouterObservation represents the observed state of a Google Compute Engine Router."
