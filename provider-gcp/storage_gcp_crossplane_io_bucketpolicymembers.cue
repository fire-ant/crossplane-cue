package storage_gcp_crossplane_io_bucketpolicymembers

customresourcedefinition: "bucketpolicymembers.storage.gcp.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "BucketPolicyMember is a managed resource that represents membership of a Google Cloud Storage Bucket IAM Policy."
						...
						properties: {
							...
							forProvider: {
								...
								properties: {
									...
									member: {
										description: """
		Member: Specifies the identity requesting access for a Cloud Platform resource. `member` can have the following values: 
