package gcp_crossplane_io_providerconfigs

customresourcedefinition: "providerconfigs.gcp.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "A ProviderConfig configures how GCP controller should connect to GCP API."
				...
				properties: {
					...
					spec: {
						...
						properties: {
							clientOptions: {
								description: "ClientOptions can override default Google API client options"
								...
								properties: {
									...
									withoutAuthentication: {
										description: "WithoutAuthentication - specifies that no authentication should be used. It is suitable only for testing and for accessing public resources."
