package apigateway_aws_crossplane_io_apikeys

customresourcedefinition: "apikeys.apigateway.aws.crossplane.io": {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "APIKeyParameters defines the desired state of APIKey"
								properties: {
									customerID: {
									...
									region: {
										description: "Region is which region the APIKey will be created."
										type:        "string"
									}
									tags: {
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "APIKeyObservation defines the observed state of APIKey"
								properties: {
									createdDate: {
