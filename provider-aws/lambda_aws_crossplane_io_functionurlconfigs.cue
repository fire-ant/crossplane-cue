package lambda_aws_crossplane_io_functionurlconfigs

customresourcedefinition: "functionurlconfigs.lambda.aws.crossplane.io": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.8.0"
		creationTimestamp: null
		name:              "functionurlconfigs.lambda.aws.crossplane.io"
	}
	spec: {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "FunctionURLConfigParameters defines the desired state of FunctionURLConfig"
								...
								properties: {
									...
									region: {
										description: "Region is which region the FunctionURLConfig will be created."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "FunctionURLConfigObservation defines the observed state of FunctionURLConfig"
