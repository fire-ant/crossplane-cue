package docdb_aws_crossplane_io_dbsubnetgroups

customresourcedefinition: "dbsubnetgroups.docdb.aws.crossplane.io": {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "DBSubnetGroupParameters defines the desired state of DBSubnetGroup"
								...
								properties: {
									...
									region: {
										description: "Region is which region the DBSubnetGroup will be created."
									...
									subnetIDsRefs: {
										description: "TODO(haarchri): when resource is bumped to beta we will convert this field to subnetIdRefs"
									...
									subnetIDsSelector: {
										description: "TODO(haarchri): when resource is bumped to beta we will convert this field to subnetIdSelector"
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "DBSubnetGroupObservation defines the observed state of DBSubnetGroup"
