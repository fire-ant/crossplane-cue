package acm_aws_crossplane_io_certificates

customresourcedefinition: "certificates.acm.aws.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			name: "v1beta1"
			schema: openAPIV3Schema: {
				description: "Certificate is a managed resource that represents an AWS Certificate Manager."
