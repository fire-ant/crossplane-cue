package dax_aws_crossplane_io_subnetgroups

customresourcedefinition: "subnetgroups.dax.aws.crossplane.io": {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "SubnetGroupParameters defines the desired state of SubnetGroup"
								properties: {
									description: {
									...
									region: {
										description: "Region is which region the SubnetGroup will be created."
										type:        "string"
									}
									subnetIDRefs: {
									...
									subnetIds: {
										description: "SubnetIds is the list of Ids for the Subnets."
										items: type: "string"
										type: "array"
									}
								}
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "SubnetGroupObservation defines the observed state of SubnetGroup"
								...
								properties: {
									...
									subnets: {
										...
										items: {
											properties: {
												subnetAvailabilityZone: type: "string"
