package apigatewayv2_aws_crossplane_io_stages

customresourcedefinition: "stages.apigatewayv2.aws.crossplane.io": {
						...
						properties: {
							...
							forProvider: {
								...
								properties: {
									...
									clientCertificateID: type: "string"
						...
						properties: {
							atProvider: {
								...
								properties: {
									...
									lastDeploymentStatusMessage: type: "string"
									lastUpdatedDate: {
										format: "date-time"
										type:   "string"
									}
