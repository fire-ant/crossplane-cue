package kms_aws_crossplane_io_keys

customresourcedefinition: "keys.kms.aws.crossplane.io": {
	...
	spec: {
		...
		"""
									...
									enableKeyRotation: {
										description: "Specifies if key rotation is enabled for the corresponding key"
		...
		"""
									...
									pendingWindowInDays: {
										description: "Specifies how many days the Key is retained when scheduled for deletion. Defaults to 30 days."
					...
					status: {
						...
						properties: {
							atProvider: {
								...
								properties: {
									arn: {
										description: "The Amazon Resource Name (ARN) of the KMS key. For examples, see Key Management Service (KMS) (https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kms) in the Example ARNs section of the Amazon Web Services General Reference."
		...
		"""
									...
									enabled: {
										description: "Specifies whether the KMS key is enabled. When KeyState is Enabled this value is true, otherwise it is false."
		...
		"""
									...
									expirationModel: {
										description: "Specifies whether the KMS key's key material expires. This value is present only when Origin is EXTERNAL, otherwise this value is omitted."
		...
		"""
										...
										properties: {
											multiRegionKeyType: type: "string"
											primaryKey: {
