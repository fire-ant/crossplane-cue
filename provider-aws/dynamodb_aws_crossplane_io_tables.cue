package dynamodb_aws_crossplane_io_tables

customresourcedefinition: "tables.dynamodb.aws.crossplane.io": {
		...
		"""
									...
									restoreSummary: {
										...
										properties: {
											...
											sourceBackupARN: type: "string"
											sourceTableARN: type: "string"
										}
										type: "object"
									}
									sseDescription: {
