package ec2_aws_crossplane_io_vpcs

customresourcedefinition: "vpcs.ec2.aws.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "A VPC is a managed resource that represents an AWS Virtual Private Cloud."
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "VPCParameters define the desired state of an AWS Virtual Private Cloud."
								...
								properties: {
									...
									cidrBlock: {
										description: "CIDRBlock is the IPv4 network range for the VPC, in CIDR notation. For example, 10.0.0.0/16."
							...
							atProvider: {
								...
								properties: {
									cidrBlockAssociationSet: {
										...
										items: {
											description: "VPCCIDRBlockAssociation represents the association of IPv4 CIDR blocks with the VPC."
									...
									ipv6CidrBlockAssociationSet: {
										...
										items: {
											description: "VPCIPv6CidrBlockAssociation represents the association of IPv6 CIDR blocks with the VPC."
