package elbv2_aws_crossplane_io_targets

customresourcedefinition: "targets.elbv2.aws.crossplane.io": {
	...
	spec: {
		...
		"""
									...
									lambdaArnRef: {
										description: "LambdaARNRef references a Lambda Function to set LambdaARN."
									...
									lambdaArnSelector: {
										description: "LambdaARNSelector references a Lambda Function to set LambdaARN."
		...
		"""
									...
									targetGroupArnRef: {
										description: "TargetGroupARNRef selects a ELBv2 TargetGroupARN with the given name."
									...
									targetGroupArnSelector: {
										description: "TargetGroupARNSelector selects a ELBv2 TargetGroupARN with the given labels."
