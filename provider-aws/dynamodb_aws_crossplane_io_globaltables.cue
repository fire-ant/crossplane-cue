package dynamodb_aws_crossplane_io_globaltables

customresourcedefinition: "globaltables.dynamodb.aws.crossplane.io": {
			...
			schema: openAPIV3Schema: {
				...
				properties: {
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "GlobalTableObservation defines the observed state of GlobalTable"
