package ec2_aws_crossplane_io_transitgateways

customresourcedefinition: "transitgateways.ec2.aws.crossplane.io": {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "TransitGatewayParameters defines the desired state of TransitGateway"
								...
								properties: {
									...
									options: {
										...
										properties: {
											...
											autoAcceptSharedAttachments: type: "string"
											defaultRouteTableAssociation: type: "string"
											defaultRouteTablePropagation: type: "string"
											dnsSupport: type: "string"
											multicastSupport: type: "string"
											transitGatewayCIDRBlocks: {
												items: type: "string"
												type: "array"
											}
											vpnECMPSupport: type: "string"
										}
										type: "object"
									}
									region: {
										description: "Region is which region the TransitGateway will be created."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "TransitGatewayObservation defines the observed state of TransitGateway"
