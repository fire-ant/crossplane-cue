package batch_aws_crossplane_io_jobqueues

customresourcedefinition: "jobqueues.batch.aws.crossplane.io": {
	...
	spec: {
		...
		"""
										...
										items: {
											description: "CustomComputeEnvironmentOrder includes custom additional fields for ComputeEnvironmentOrder"
		...
		"""
												...
												computeEnvironmentRef: {
													description: "ComputeEnvironmentRef is a reference to ComputeEnvironment used to set the ComputeEnvironment."
												...
												computeEnvironmentSelector: {
													description: "ComputeEnvironmentsSelector selects a reference to ComputeEnvironment used to set the ComputeEnvironment."
		...
		"""
									...
									tags: {
										additionalProperties: type: "string"
										description: "The tags that you apply to the job queue to help you categorize and organize your resources. Each tag consists of a key and an optional value. For more information, see Tagging your Batch resources (https://docs.aws.amazon.com/batch/latest/userguide/using-tags.html) in Batch User Guide."
						...
						properties: {
							atProvider: {
								...
								properties: {
									...
									state: {
										description: "Describes the ability of the queue to accept new jobs. If the job queue state is ENABLED, it's able to accept jobs. If the job queue state is DISABLED, new jobs can't be added to the queue, but jobs already in the queue can finish."
