package apigatewayv2_aws_crossplane_io_authorizers

customresourcedefinition: "authorizers.apigatewayv2.aws.crossplane.io": {
						...
						properties: {
							...
							forProvider: {
								...
								properties: {
									...
									authorizerCredentialsARN: type: "string"
									authorizerPayloadFormatVersion: type: "string"
									authorizerResultTtlInSeconds: {
										format: "int64"
										type:   "integer"
									}
									authorizerType: type: "string"
									authorizerURI: type: "string"
					...
					status: {
						...
						properties: {
							atProvider: {
								...
								properties: authorizerID: type: "string"
								type: "object"
							}
							conditions: {
