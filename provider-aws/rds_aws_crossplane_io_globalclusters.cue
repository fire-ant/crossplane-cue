package rds_aws_crossplane_io_globalclusters

customresourcedefinition: "globalclusters.rds.aws.crossplane.io": {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "GlobalClusterParameters defines the desired state of GlobalCluster"

								properties: {
									databaseName: {
										description: "The name for your database of up to 64 alpha-numeric characters. If you do not provide a name, Amazon Aurora will not create a database in the global database cluster you are creating."
									...
									region: {
										description: "Region is which region the GlobalCluster will be created."
									...
									sourceDBClusterIdentifierRef: {
										description: "SourceDBClusterIdentifierRef is a reference to a DBCluster used to set SourceDBClusterIdentifier."
									...
									sourceDBClusterIdentifierSelector: {
										description: "SourceDBClusterIdentifierSelector selects a reference to a DBCluster used to set SourceDBClusterIdentifier."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "GlobalClusterObservation defines the observed state of GlobalCluster"
								...
								properties: {
									failoverState: {
										...
										properties: {
											fromDBClusterARN: type: "string"
											status: type: "string"
											toDBClusterARN: type: "string"
										}
										type: "object"
									}
									globalClusterARN: {
									...
									globalClusterMembers: {
										description: "The list of cluster IDs for secondary clusters within the global database cluster. Currently limited to 1 item."

										items: {
											properties: {
												dbClusterARN: type: "string"
												globalWriteForwardingStatus: type: "string"
