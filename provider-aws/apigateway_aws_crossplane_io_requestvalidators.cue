package apigateway_aws_crossplane_io_requestvalidators

customresourcedefinition: "requestvalidators.apigateway.aws.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "RequestValidator is the Schema for the RequestValidators API"
				properties: {
					apiVersion: {
					...
					spec: {
						description: "RequestValidatorSpec defines the desired state of RequestValidator"
						properties: {
							deletionPolicy: {
								default:     "Delete"
							...
							forProvider: {
								description: "RequestValidatorParameters defines the desired state of RequestValidator"
								...
								properties: {
									...
									region: {
										description: "Region is which region the RequestValidator will be created."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "RequestValidatorObservation defines the observed state of RequestValidator"
