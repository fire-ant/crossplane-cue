package apigateway_aws_crossplane_io_integrations

customresourcedefinition: "integrations.apigateway.aws.crossplane.io": {
						...
						properties: {
							...
							forProvider: {
								...
								properties: {
									...
									connectionID: {
										description: "The (id (https://docs.aws.amazon.com/apigateway/api-reference/resource/vpc-link/#id)) of the VpcLink used for the integration when connectionType=VPC_LINK and undefined, otherwise."
