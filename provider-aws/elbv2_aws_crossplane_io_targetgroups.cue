package elbv2_aws_crossplane_io_targetgroups

customresourcedefinition: "targetgroups.elbv2.aws.crossplane.io": {
	...
	spec: {
		...
		"""
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "TargetGroupObservation defines the observed state of TargetGroup"

								properties: targetGroups: {
									...
									items: {
										properties: {
											...
											healthCheckProtocol: type: "string"
											healthCheckTimeoutSeconds: {
												format: "int64"
												type:   "integer"
											}
