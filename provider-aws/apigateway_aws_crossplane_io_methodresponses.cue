package apigateway_aws_crossplane_io_methodresponses

customresourcedefinition: "methodresponses.apigateway.aws.crossplane.io": {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "MethodResponseParameters defines the desired state of MethodResponse"
								...
								properties: {
									...
									region: {
										description: "Region is which region the MethodResponse will be created."
									...
									resourceIdRef: {
										description: "ResourceIDRef is a reference to an Resource used to set the ResourceID."
									...
									resourceIdSelector: {
										description: "RestApiIdSelector selects references to Resource used to set the ResourceID."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "MethodResponseObservation defines the observed state of MethodResponse"
