package cognitoidentityprovider_aws_crossplane_io_resourceservers

customresourcedefinition: "resourceservers.cognitoidentityprovider.aws.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "ResourceServer is the Schema for the ResourceServers API"
				properties: {
					apiVersion: {
					...
					spec: {
						description: "ResourceServerSpec defines the desired state of ResourceServer"
						properties: {
							deletionPolicy: {
								default:     "Delete"
							...
							forProvider: {
								description: "ResourceServerParameters defines the desired state of ResourceServer"
								...
								properties: {
									...
									region: {
										description: "Region is which region the ResourceServer will be created."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "ResourceServerObservation defines the observed state of ResourceServer"
