package apigateway_aws_crossplane_io_gatewayresponses

customresourcedefinition: "gatewayresponses.apigateway.aws.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "GatewayResponse is the Schema for the GatewayResponses API"
				properties: {
					apiVersion: {
					...
					spec: {
						description: "GatewayResponseSpec defines the desired state of GatewayResponse"
						properties: {
							deletionPolicy: {
								default:     "Delete"
							...
							forProvider: {
								description: "GatewayResponseParameters defines the desired state of GatewayResponse"

								properties: {
									region: {
										description: "Region is which region the GatewayResponse will be created."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "GatewayResponseObservation defines the observed state of GatewayResponse"
