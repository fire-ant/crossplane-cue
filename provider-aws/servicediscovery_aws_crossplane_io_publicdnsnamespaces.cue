package servicediscovery_aws_crossplane_io_publicdnsnamespaces

customresourcedefinition: "publicdnsnamespaces.servicediscovery.aws.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "PublicDNSNamespace is the Schema for the PublicDNSNamespaces API"
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "PublicDNSNamespaceParameters defines the desired state of PublicDNSNamespace"
								...
								properties: {
									...
									region: {
										description: "Region is which region the PublicDNSNamespace will be created."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "PublicDNSNamespaceObservation defines the observed state of PublicDNSNamespace"
