package apigatewayv2_aws_crossplane_io_domainnames

customresourcedefinition: "domainnames.apigatewayv2.aws.crossplane.io": {
							...
							forProvider: {
								...
								properties: {
									domainNameConfigurations: {
										items: {
											properties: {
												apiGatewayDomainName: type: "string"
												certificateARN: {
												...
												domainNameStatusMessage: type: "string"
												endpointType: {
					...
					status: {
						...
						properties: {
							atProvider: {
								...
								properties: {
									apiMappingSelectionExpression: type: "string"
