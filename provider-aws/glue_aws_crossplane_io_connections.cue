package glue_aws_crossplane_io_connections

customresourcedefinition: "connections.glue.aws.crossplane.io": {
	...
	spec: {
		...
		"""
											...
											physicalConnectionRequirements: {
												...
												properties: {
													availabilityZone: {
														description: "The connection's Availability Zone. This field is redundant because the specified subnet implies the Availability Zone to be used. Currently the field must be populated, but it will be removed in the future."
													...
													subnetIdRef: {
														description: "SubnetIDRef is a reference to SubnetID used to set the SubnetID."
													...
													subnetIdSelector: {
														description: "SubnetIDSelector selects a reference to SubnetID used to set the SubnetID."
