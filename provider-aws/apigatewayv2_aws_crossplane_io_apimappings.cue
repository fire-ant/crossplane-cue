package apigatewayv2_aws_crossplane_io_apimappings

customresourcedefinition: "apimappings.apigatewayv2.aws.crossplane.io": {
						...
						properties: {
							...
							forProvider: {
								...
								properties: {
									...
									stageRef: {
										description: "StageDRef is a reference to an Stage used to set the Stage."
									...
									stageSelector: {
										description: "StageSelector selects references to Stage used to set the Stage."
