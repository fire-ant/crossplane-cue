package prometheusservice_aws_crossplane_io_workspaces

customresourcedefinition: "workspaces.prometheusservice.aws.crossplane.io": {
						...
						properties: {
							...
							forProvider: {
								...
								properties: {
									...
									region: {
										description: "Region is which region the Workspace will be created."
										type:        "string"
									}
									tags: {
