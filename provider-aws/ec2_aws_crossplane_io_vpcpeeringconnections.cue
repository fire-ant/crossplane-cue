package ec2_aws_crossplane_io_vpcpeeringconnections

customresourcedefinition: "vpcpeeringconnections.ec2.aws.crossplane.io": {
	...
	spec: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								...
								properties: {
									acceptRequest: {
										description: "Automatically accepts the peering connection. If this is not set, the peering connection will be created, but will be in pending-acceptance state. This will only lead to an active connection if both VPCs are in the same tenant."

										type: "boolean"
									}
									accepterPeeringOptions: {
										description: "AccepterRequesterPeeringOptions describes the Accepter VPC peering connection options."

										properties: {
											allowDNSResolutionFromRemoteVPC: type: "boolean"
											allowEgressFromLocalClassicLinkToRemoteVPC: type: "boolean"
											allowEgressFromLocalVPCToRemoteClassicLink: type: "boolean"
										}
										type: "object"
									}
									peerOwnerID: {
		...
		"""
									...
									peerVPCIDRef: {
										description: "PeerVPCIDRef is a reference to an API used to set the PeerVPCID."
									...
									peerVPCIDSelector: {
										description: "PeerVPCIDSelector selects references to API used to set the PeerVPCID."
									...
									requesterPeeringOptions: {
										description: "RequesterPeeringOptions describes the Requester VPC peering connection options."
								...
								properties: {
									accepterVPCInfo: {
										...
										properties: {
											...
											ipv6CIDRBlockSet: {
												items: {
													properties: ipv6CIDRBlock: type: "string"
													type: "object"
												}
												type: "array"
											}
