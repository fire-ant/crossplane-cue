package kafka_aws_crossplane_io_configurations

customresourcedefinition: "configurations.kafka.aws.crossplane.io": {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "ConfigurationParameters defines the desired state of Configuration"
								...
								properties: {
									...
									properties: {
										description: "kafka server configurations"
										items: type: "string"
										type: "array"
									}
									region: {
										description: "Region is which region the Configuration will be created."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "ConfigurationObservation defines the observed state of Configuration"
								...
								properties: {
									...
									name: {
										description: "The name of the configuration. Configuration names are strings that match the regex \"^[0-9A-Za-z-]+$\"."
