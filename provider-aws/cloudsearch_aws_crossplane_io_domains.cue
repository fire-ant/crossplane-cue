package cloudsearch_aws_crossplane_io_domains

customresourcedefinition: "domains.cloudsearch.aws.crossplane.io": {
						...
						properties: {
							...
							forProvider: {
								...
								properties: {
									...
									desiredInstanceType: {
										description: "The desired instance type that is being used to process search requests."

										type: "string"
									}
									desiredPartitionCount: {
										description: "The desired number of partitions across which the search index is spread."

										format: "int64"
										type:   "integer"
									}
									desiredReplicationCount: {
										description: "The desired number of search instances that are available to process search requests."
							...
							atProvider: {
								...
								properties: {
									...
									docService: {
										...
										properties: endpoint: {
											description: "The endpoint to which service requests can be submitted. For example, search-imdb-movies-oopcnjfn6ugofer3zx5iadxxca.eu-west-1.cloudsearch.amazonaws.com or doc-imdb-movies-oopcnjfn6ugofer3zx5iadxxca.eu-west-1.cloudsearch.amazonaws.com."
