package dax_aws_crossplane_io_parametergroups

customresourcedefinition: "parametergroups.dax.aws.crossplane.io": {
	...
	spec: {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "ParameterGroupParameters defines the desired state of ParameterGroup"
		...
		"""
									...
									region: {
										description: "Region is which region the ParameterGroup will be created."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "ParameterGroupObservation defines the observed state of ParameterGroup"
