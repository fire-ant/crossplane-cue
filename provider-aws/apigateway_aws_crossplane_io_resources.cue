package apigateway_aws_crossplane_io_resources

customresourcedefinition: "resources.apigateway.aws.crossplane.io": {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "ResourceParameters defines the desired state of Resource"
								properties: {
									parentResourceId: {
										description: "ParentID is the ID for the Parent."
										type:        "string"
									}
									parentResourceIdRef: {
										description: "ParentIDRef is a reference to an Parent used to set the ParentID."
									...
									parentResourceIdSelector: {
										description: "RestApiIdSelector selects references to Parent used to set the ParentID."
									...
									region: {
										description: "Region is which region the Resource will be created."
										type:        "string"
									}
									restApiId: {
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "ResourceObservation defines the observed state of Resource"
								properties: {
									id: {
