package ec2_aws_crossplane_io_transitgatewayvpcattachments

customresourcedefinition: "transitgatewayvpcattachments.ec2.aws.crossplane.io": {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "TransitGatewayVPCAttachmentParameters defines the desired state of TransitGatewayVPCAttachment"

								properties: {
									options: {
										description: "The VPC attachment options."
										properties: {
											applianceModeSupport: type: "string"
											dnsSupport: type: "string"
											ipv6Support: type: "string"
										}
										type: "object"
									}
									region: {
										description: "Region is which region the TransitGatewayVPCAttachment will be created."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "TransitGatewayVPCAttachmentObservation defines the observed state of TransitGatewayVPCAttachment"
