package apigateway_aws_crossplane_io_integrationresponses

customresourcedefinition: "integrationresponses.apigateway.aws.crossplane.io": {
	...
	spec: {
		...
		"""
									...
									resourceIdRef: {
										description: "ResourceIDRef is a reference to an Parent used to set the ResourceID."
									...
									resourceIdSelector: {
										description: "ResourceIDSelector selects references to Parent used to set the ResourceID."
