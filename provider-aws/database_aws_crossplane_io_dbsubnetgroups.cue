package database_aws_crossplane_io_dbsubnetgroups

customresourcedefinition: "dbsubnetgroups.database.aws.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "A DBSubnetGroup is a managed resource that represents an AWS VPC Database Subnet Group."
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "DBSubnetGroupParameters define the desired state of an AWS VPC Database Subnet Group."
								...
								properties: {
									...
									region: {
										description: "Region is the region you'd like your DBSubnetGroup to be created in."

										type: "string"
									}
									subnetIdRefs: {
										description: "SubnetIDRefs is a set of references that each retrieve the subnetID from the referenced Subnet"
									...
									subnetIdSelector: {
										description: "SubnetIDSelector selects a set of references that each retrieve the subnetID from the referenced Subnet"
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "DBSubnetGroupObservation is the representation of the current state that is observed"

								properties: {
									arn: {
										description: "ARN is the Amazon Resource Name (ARN) for this DB subnet group."

										type: "string"
									}
									state: {
										description: "State specifies the current state of this DB subnet group."
