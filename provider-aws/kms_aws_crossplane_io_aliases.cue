package kms_aws_crossplane_io_aliases

customresourcedefinition: "aliases.kms.aws.crossplane.io": {
	...
	spec: {
		...
		"""
									...
									targetKeyIdRef: {
										description: "TargetKeyIDRef is a reference to a KMS Key used to set TargetKeyID."
									...
									targetKeyIdSelector: {
										description: "TargetKeyIDSelector selects a reference to a KMS Key used to set TargetKeyID."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "AliasObservation defines the observed state of Alias"
								type:        "object"
							}
							conditions: {
