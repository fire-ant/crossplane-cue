package ec2_aws_crossplane_io_flowlogs

customresourcedefinition: "flowlogs.ec2.aws.crossplane.io": {
	...
	spec: {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "FlowLogParameters defines the desired state of FlowLog"
								properties: {
									clientToken: {
										description: "Unique, case-sensitive identifier that you provide to ensure the idempotency of the request. For more information, see How to ensure idempotency (https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Run_Instance_Idempotency.html)."

										type: "string"
									}
									cloudWatchLogDestination: {
										description: "The Amazon Resource Names (ARNs) of a CloudWatch Log Group."

										type: "string"
									}
									cloudWatchLogDestinationRef: {
										description: "CloudWatchLogDestinationRef is a reference to a CloudWatch Log Group used to set the CloudWatchLogDestination."
									...
									cloudWatchLogDestinationSelector: {
										description: "CloudWatchLogDestinationSelector selects a reference to a CloudWatch Log Group used to set the CloudWatchLogDestination."
									...
									deliverLogsPermissionArnRef: {
										description: "DeliverLogsPermissionARNRef is a reference to DeliverLogsPermissionARN used to set the DeliverLogsPermissionARN."
									...
									deliverLogsPermissionArnSelector: {
										description: "DeliverLogsPermissionARNelector selects a reference to DeliverLogsPermissionARN used to set the DeliverLogsPermissionARN."
									...
									destinationOptions: {
										...
										properties: {
											...
											hiveCompatiblePartitions: type: "boolean"
											perHourPartition: type: "boolean"
										}
										type: "object"
									}
									logDestination: {
		...
		"""
									...
									networkInterfaceId: {
										description: "The ID of the NetworkInterface for which you want to create a flow log."

										type: "string"
									}
									region: {
										description: "Region is which region the FlowLog will be created."
										type:        "string"
									}
									resourceIDs: {
										description: """
		...
		"""
									...
									s3BucketLogDestinationRef: {
										description: "S3BucketLogDestinationRef is a reference to a S3 Bucket  to set the S3BucketLogDestination."
									...
									s3BucketLogDestinationSelector: {
										description: "S3BucketLogDestinationSelector selects a reference to a S3 Bucket used to set the S3BucketLogDestination."
									...
									s3BucketSubfolder: {
										description: "S3BucketSubfolder allows you to use a subfolder in a S3Bucket, if S3BucketLogDestination is used to determin the ARN of a Bucket managed by crossplane S3BucketSubfolder starts and ends without an slash e.g. test/test2 You cannot use AWSLogs as a subfolder name. This is a reserved term."

										type: "string"
									}
									subnetId: {
										description: "The ID of the one or more Subnets for which you want to create a flow log."

										type: "string"
									}
									subnetIdRef: {
										description: "SubnetIDRefs is a referenc to a SubnetID used to set the SubnetID."
									...
									subnetIdSelector: {
										description: "SubnetIDSelector selects reference to a SubnetID used to set the SubnetID."
									...
									transitGatewayAttachmentId: {
										description: "The ID of the TransitGatewayAttachment for which you want to create a flow log."

										type: "string"
									}
									transitGatewayAttachmentIdRef: {
										description: "TransitGatewayAttachmentIDRef is a reference to an API used to set the TransitGatewayAttachmentID."
									...
									transitGatewayAttachmentIdSelector: {
										description: "TransitGatewayAttachmentIDSelector selects references to API used to set the TransitGatewayAttachmentID."
									...
									transitGatewayId: {
										description: "The ID of the TransitGateway for which you want to create a flow log."
									...
									vpcId: {
										description: "The ID of the VPC for which you want to create a flow log."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "FlowLogObservation defines the observed state of FlowLog"
								properties: {
									creationTime: {
