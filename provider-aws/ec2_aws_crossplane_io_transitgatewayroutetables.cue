package ec2_aws_crossplane_io_transitgatewayroutetables

customresourcedefinition: "transitgatewayroutetables.ec2.aws.crossplane.io": {
	...
	spec: {
		...
		names: {
			...
			listKind: "TransitGatewayRouteTableList"
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "TransitGatewayRouteTable is the Schema for the TransitGatewayRouteTables API"
				...
				properties: {
					...
					spec: {
						description: "TransitGatewayRouteTableSpec defines the desired state of TransitGatewayRouteTable"
						...
						properties: {
							...
							forProvider: {
								description: "TransitGatewayRouteTableParameters defines the desired state of TransitGatewayRouteTable"

								properties: {
									region: {
										description: "Region is which region the TransitGatewayRouteTable will be created."
					...
					status: {
						description: "TransitGatewayRouteTableStatus defines the observed state of TransitGatewayRouteTable."

						properties: {
							atProvider: {
								description: "TransitGatewayRouteTableObservation defines the observed state of TransitGatewayRouteTable"
