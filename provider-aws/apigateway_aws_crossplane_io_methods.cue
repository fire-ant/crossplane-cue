package apigateway_aws_crossplane_io_methods

customresourcedefinition: "methods.apigateway.aws.crossplane.io": {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "MethodParameters defines the desired state of Method"
								properties: {
									apiKeyRequired: {
									...
									authorizationType: {
										description: "[Required] The method's authorization type. Valid values are NONE for open access, AWS_IAM for using AWS IAM permissions, CUSTOM for using a custom authorizer, or COGNITO_USER_POOLS for using a Cognito user pool."
									...
									authorizerIdSelector: {
										description: "RestApiIdSelector selects references to Authorizer used to set the AuthorizerID."
									...
									region: {
										description: "Region is which region the Method will be created."
										type:        "string"
									}
									requestModels: {
										additionalProperties: type: "string"
									...
									requestValidatorIdRef: {
										description: "RequestValidatorIDRef is a reference to an RequestValidator used to set the RequestValidatorID."
									...
									requestValidatorIdSelector: {
										description: "RequestValidatorIDSelector selects references to RequestValidator used to set the RequestValidatorID."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "MethodObservation defines the observed state of Method"
								type:        "object"
							}
							conditions: {
