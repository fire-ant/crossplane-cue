package servicediscovery_aws_crossplane_io_privatednsnamespaces

customresourcedefinition: "privatednsnamespaces.servicediscovery.aws.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "PrivateDNSNamespace is the Schema for the PrivateDNSNamespaces API"
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "PrivateDNSNamespaceParameters defines the desired state of PrivateDNSNamespace"
								...
								properties: {
									...
									region: {
										description: "Region is which region the PrivateDNSNamespace will be created."
									...
									vpc: {
										description: "VPC of the PrivateDNSNamespace. One if vpc, vpcRef or vpcSelector has to be supplied."
									...
									vpcSelector: {
										description: "A selector to select a referencer to retrieve the ID of a VPC."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "PrivateDNSNamespaceObservation defines the observed state of PrivateDNSNamespace"

								properties: operationID: {
									description: "A value that you can use to determine whether the request completed successfully. To get the status of the operation, see GetOperation (https://docs.aws.amazon.com/cloud-map/latest/api/API_GetOperation.html)."
