package acmpca_aws_crossplane_io_certificateauthorities

customresourcedefinition: "certificateauthorities.acmpca.aws.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "CertificateAuthority is a managed resource that represents an AWS CertificateAuthority Manager. Deprecated: Please use v1beta1 version of this resource."
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "CertificateAuthorityParameters defines the desired state of an AWS CertificateAuthority."

								properties: {
									certificateAuthorityConfiguration: {
										description: "CertificateAuthorityConfiguration to associate with the certificateAuthority."
										...
										properties: {
											...
											signingAlgorithm: {
												description: "Algorithm that private CA uses to sign certificate requests"
											...
											subject: {
												...
												properties: {
													...
													initials: {
														description: "Concatenation of first letter of the GivenName, Middle name and SurName."
									...
									permanentDeletionTimeInDays: {
										description: "The number of days to make a CA restorable after it has been deleted"

										format: "int32"
										type:   "integer"
									}
									region: {
										description: "Region is the region you'd like your CertificateAuthority to be created in."
									...
									status: {
										description: "Status of the certificate authority. This value cannot be configured at creation, but can be updated to set a CA to ACTIVE or DISABLED."
					...
					status: {
						description: "An CertificateAuthorityStatus represents the observed state of an CertificateAuthority manager."

						properties: {
							atProvider: {
								description: "CertificateAuthorityExternalStatus keeps the state of external resource"

								properties: {
									certificateAuthorityARN: {
										description: "String that contains the ARN of the issued certificate Authority"
			...
			name: "v1beta1"
			schema: openAPIV3Schema: {
				description: "CertificateAuthority is a managed resource that represents an AWS CertificateAuthority Manager."
