package ec2_aws_crossplane_io_routetables

customresourcedefinition: "routetables.ec2.aws.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "A RouteTable is a managed resource that represents an AWS VPC Route Table."
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "RouteTableParameters define the desired state of an AWS VPC Route Table."
								...
								properties: {
									associations: {
										...
										items: {
											description: "Association describes an association between a route table and a subnet."
											...
											properties: {
												...
												subnetIdSelector: {
													description: "A selector to select a referencer to retrieve the ID of a subnet"
									...
									routes: {
										description: "inline routes in the route table Deprecated: Routes inline exists for historical compatibility and should not be used. Please use separate route resource."

										items: {
											description: "RouteBeta describes a route in a route table. provider-aws currently provides both a standalone Route resource and a RouteTable resource with routes defined in-line. At this time you cannot use a Route Table with in-line routes in conjunction with any Route resources. Doing so will cause a conflict of rule settings and will overwrite rules."
											...
											properties: {
												...
												destinationIpv6CidrBlock: {
													description: "The IPv6 CIDR address block used for the destination match. Routing decisions are based on the most specific match."
												...
												gatewayIdSelector: {
													description: "A selector to select a referencer to retrieve the ID of a gateway"
												...
												natGatewayIdSelector: {
													description: "A selector to select a referencer to retrieve the ID of a NAT gateway"
									...
									vpcIdSelector: {
										description: "VPCIDSelector selects a reference to a VPC to retrieve its vpcId"
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "RouteTableObservation keeps the state for the external resource"

								properties: {
									associations: {
										description: "The actual associations created for the route table."
										items: {
											description: "AssociationState describes an association state in the route table."
