package route53resolver_aws_crossplane_io_resolverendpoints

customresourcedefinition: "resolverendpoints.route53resolver.aws.crossplane.io": {
	...
	spec: {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "ResolverEndpointParameters defines the desired state of ResolverEndpoint"
		...
		"""
									...
									ipAddresses: {
										description: "IPAddresses are the subnets and IP addresses in your VPC that DNS queries originate from (for outbound endpoints) or that you forward DNS queries to (for inbound endpoints). The subnet ID uniquely identifies a VPC."
										...
										items: {
											...
											properties: {
												...
												subnetId: {
													description: "SubnetId is the ID of the subnet that contains the IP address."
									...
									region: {
										description: "Region is which region the ResolverEndpoint will be created."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "ResolverEndpointObservation defines the observed state of ResolverEndpoint"
								...
								properties: {
									...
									creatorRequestID: {
										description: "A unique string that identifies the request that created the Resolver endpoint. The CreatorRequestId allows failed requests to be retried without the risk of running the operation twice."
