package ec2_aws_crossplane_io_subnets

customresourcedefinition: "subnets.ec2.aws.crossplane.io": {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "SubnetParameters define the desired state of an AWS VPC Subnet."
								...
								properties: {
									...
									cidrBlock: {
										description: "CIDRBlock is the IPv4 network range for the Subnet, in CIDR notation. For example, 10.0.0.0/18."
									...
									region: {
										description: "Region is the region you'd like your Subnet to be created in."
