package dynamodb_aws_crossplane_io_backups

customresourcedefinition: "backups.dynamodb.aws.crossplane.io": {
						...
						properties: {
							...
							forProvider: {
								...
								properties: {
									...
									tableName: {
										description: "TableName is the name of the Table whose backup will be taken."

										type: "string"
									}
									tableNameRef: {
										description: "TableNameRef points to the Table resource whose Name will be used to fill TableName field."
							...
							atProvider: {
								...
								properties: {
									...
									backupExpiryDateTime: {
										description: "Time at which the automatic on-demand backup created by DynamoDB will expire. This SYSTEM on-demand backup expires automatically 35 days after its creation."
