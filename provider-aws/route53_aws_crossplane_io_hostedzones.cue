package route53_aws_crossplane_io_hostedzones

customresourcedefinition: "hostedzones.route53.aws.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "HostedZone is a managed resource that represents an AWS Route53 Hosted HostedZone."
				...
				properties: {
					...
					spec: {
						description: "HostedZoneSpec defines the desired state of an AWS Route53 Hosted HostedZone."
						...
						properties: {
							...
							forProvider: {
								description: "HostedZoneParameters define the desired state of an AWS Route53 Hosted HostedZone."

								properties: {
									config: {
										description: "Config includes the Comment and PrivateZone elements. If you omitted the Config and Comment elements from the request, the Config and Comment elements don't appear in the response."

										properties: {
											comment: {
												description: "Comment that you want to include about the hosted zone."

												type: "string"
											}
											privateZone: {
												description: "PrivateZone indicates whether this is a private hosted zone."
		...
		"""
										...
										properties: {
											...
											vpcIdRef: {
												description: "(Private hosted Hostedzones only) VPCIDRef references a VPC to retrieves its VPC Id."
						...
						properties: {
							atProvider: {
								...
								properties: {
									...
									hostedZone: {
										description: "HostedZone contains general information about the hosted zone."

										properties: {
											callerReference: {
												description: "CallerReference is an unique string that identifies the request and that allows failed HostedZone create requests to be retried without the risk of executing the operation twice."

												type: "string"
											}
											id: {
												description: "ID that Amazon Route 53 assigned to the hosted zone when you created it."

												type: "string"
											}
											linkedService: {
												description: "LinkedService is the service that created the hosted zone."
												...
												properties: {
													...
													servicePrincipal: {
														description: "ServicePrincipal is the service that created the resource."
									...
									vpcs: {
										...
										items: {
											description: "VPCObservation is used to represent the VPC object in the HostedZone response object."
