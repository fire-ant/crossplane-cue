package sns_aws_crossplane_io_topics

customresourcedefinition: "topics.sns.aws.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "Topic defines a managed resource that represents state of a AWS Topic"
				...
				properties: {
					...
					spec: {
						description: "TopicSpec defined the desired state of a AWS SNS Topic"
						properties: {
							deletionPolicy: {
								default:     "Delete"
							...
							forProvider: {
								description: "TopicParameters define the desired state of a AWS SNS Topic"

								properties: {
									deliveryPolicy: {
										description: "DeliveryRetryPolicy - the JSON serialization of the effective delivery policy, taking system defaults into account"
									...
									fifoTopic: {
										description: "Whether or not this should be a fifo-topic"
										type:        "boolean"
									}
									kmsMasterKeyId: {
										description: """
		...
		"""
									...
									region: {
										description: "Region is the region you'd like your Topic to be created in."
		...
		"""
					...
					status: {
						description: "TopicStatus is the status of AWS SNS Topic"
						properties: {
							atProvider: {
								description: "TopicObservation represents the observed state of a AWS SNS Topic"
