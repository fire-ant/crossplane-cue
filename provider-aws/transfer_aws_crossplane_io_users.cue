package transfer_aws_crossplane_io_users

customresourcedefinition: "users.transfer.aws.crossplane.io": {
	...
	spec: {
		...
		"""
									...
									homeDirectoryType: {
										description: "The type of landing directory (folder) you want your users' home directory to be when they log into the server. If you set it to PATH, the user will see the absolute Amazon S3 bucket or EFS paths as is in their file transfer protocol clients. If you set it LOGICAL, you need to provide mappings in the HomeDirectoryMappings for how you want to make Amazon S3 or EFS paths visible to your users."
		...
		"""
									...
									serverIDSelector: {
										description: "ServerIDSelector selects references to an server instance."
						...
						properties: {
							atProvider: {
								...
								properties: {
									...
									userName: {
										description: "A unique string that identifies a user account associated with a server."
