package elbv2_aws_crossplane_io_loadbalancers

customresourcedefinition: "loadbalancers.elbv2.aws.crossplane.io": {
	...
	spec: {
		...
		"""
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "LoadBalancerObservation defines the observed state of LoadBalancer"
