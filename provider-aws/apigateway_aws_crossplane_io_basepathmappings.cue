package apigateway_aws_crossplane_io_basepathmappings

customresourcedefinition: "basepathmappings.apigateway.aws.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "BasePathMapping is the Schema for the BasePathMappings API"
				properties: {
					apiVersion: {
					...
					spec: {
						description: "BasePathMappingSpec defines the desired state of BasePathMapping"
						properties: {
							deletionPolicy: {
								default:     "Delete"
							...
							forProvider: {
								description: "BasePathMappingParameters defines the desired state of BasePathMapping"
								...
								properties: {
									...
									domainName: {
										description: "[Required] The domain name of the BasePathMapping resource to create."

										type: "string"
									}
									region: {
										description: "Region is which region the BasePathMapping will be created."
					...
					status: {
						description: "BasePathMappingStatus defines the observed state of BasePathMapping."
						properties: {
							atProvider: {
								description: "BasePathMappingObservation defines the observed state of BasePathMapping"
