package sfn_aws_crossplane_io_statemachines

customresourcedefinition: "statemachines.sfn.aws.crossplane.io": {
	...
	spec: {
		...
		"""
										...
										properties: {
											destinations: {
												items: {
													properties: cloudWatchLogsLogGroup: {
		...
		"""
									...
									roleArn: {
										description: "RoleARN is the ARN for the IAMRole. It has to be given directly or resolved using RoleARNRef or RoleARNSelector."
		...
		"""
									...
									type: {
										description: "Determines whether a Standard or Express state machine is created. You cannot update the type of a state machine once it has been created. The default is STANDARD. Possible values: STANDARD, EXPRESS"
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "StateMachineObservation defines the observed state of StateMachine"
