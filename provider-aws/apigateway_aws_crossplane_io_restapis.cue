package apigateway_aws_crossplane_io_restapis

customresourcedefinition: "restapis.apigateway.aws.crossplane.io": {
	...
	spec: {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "RestAPIParameters defines the desired state of RestAPI"
								properties: {
									apiKeySource: {
										description: """
		...
		"""
									...
									region: {
										description: "Region is which region the RestAPI will be created."
										type:        "string"
									}
									tags: {
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "RestAPIObservation defines the observed state of RestAPI"
								properties: {
									createdDate: {
