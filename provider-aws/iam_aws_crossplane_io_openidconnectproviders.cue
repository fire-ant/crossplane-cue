package iam_aws_crossplane_io_openidconnectproviders

customresourcedefinition: "openidconnectproviders.iam.aws.crossplane.io": {
	...
	spec: {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "OpenIDConnectProviderParameters defines the desired state of OpenIDConnectProvider"
		...
		"""
									...
									tags: {
										description: "Tags. For more information about tagging, see Tagging OpenID Connect (OIDC) identity providers (https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags_idps_oidc.html) in the IAM User Guide."
		...
		"""
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "OpenIDConnectProviderObservation defines the observed state of OpenIDConnectProvider"
