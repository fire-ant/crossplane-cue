package mq_aws_crossplane_io_users

customresourcedefinition: "users.mq.aws.crossplane.io": {
						...
						properties: {
							...
							forProvider: {
								...
								properties: {
									...
									brokerIDRef: {
										description: "BrokerIDRef is a reference to a Broker used to set BrokerID."
									...
									brokerIDSelector: {
										description: "BrokerIDSelector selects a reference to a Broker used to set BrokerID."
