package ec2_aws_crossplane_io_transitgatewayroutes

customresourcedefinition: "transitgatewayroutes.ec2.aws.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "TransitGatewayRoute is the Schema for the TransitGatewayRoutes API"
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "TransitGatewayRouteParameters defines the desired state of TransitGatewayRoute"
								...
								properties: {
									...
									region: {
										description: "Region is which region the TransitGatewayRoute will be created."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "TransitGatewayRouteObservation defines the observed state of TransitGatewayRoute"
