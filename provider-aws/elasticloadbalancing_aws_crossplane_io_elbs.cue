package elasticloadbalancing_aws_crossplane_io_elbs

customresourcedefinition: "elbs.elasticloadbalancing.aws.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "An ELB is a managed resource that represents an AWS Classic Load Balancer."
							...
							forProvider: {
								...
								properties: {
									...
									listeners: {
										...
										items: {
											description: "Listener represents the port binding(s) between the ELB and EC2 instances."
											...
											properties: {
												...
												instanceProtocol: {
													description: "The protocol to use for routing traffic to instances: HTTP, HTTPS, TCP, or SSL. If not specified, the value is same as for Protocol."
									...
									region: {
										description: "Region is the region you'd like your ELB to be created in."
									...
									securityGroupIdRefs: {
										description: "SecurityGroupIDRefs references to a SecurityGroup and retrieves its SecurityGroupID"
									...
									securityGroupIdSelector: {
										description: "SecurityGroupIDSelector selects a set of references that each retrieve the SecurityGroupID from the referenced SecurityGroup"
									...
									subnetIdRefs: {
										description: "SubnetRefs references to a Subnet to and retrieves its SubnetID"
									...
									subnetIdSelector: {
										description: "SubnetSelector selects a set of references that each retrieve the subnetID from the referenced Subnet"
									...
									tags: {
										...
										items: {
											description: "Tag defines a key value pair that can be attached to an ELB"
							...
							atProvider: {
								...
								properties: {
									backendServerDescriptions: {
										...
										items: {
											description: "BackendServerDescription provides information about the instances attached to the ELB."
