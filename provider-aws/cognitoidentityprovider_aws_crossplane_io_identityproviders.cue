package cognitoidentityprovider_aws_crossplane_io_identityproviders

customresourcedefinition: "identityproviders.cognitoidentityprovider.aws.crossplane.io": {
	...
	spec: {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "IdentityProviderParameters defines the desired state of IdentityProvider"
		...
		"""
									...
									region: {
										description: "Region is which region the IdentityProvider will be created."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "IdentityProviderObservation defines the observed state of IdentityProvider"
