package sns_aws_crossplane_io_subscriptions

customresourcedefinition: "subscriptions.sns.aws.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "Subscription defines a managed resource that represents state of a AWS SNS Subscription"
				...
				properties: {
					...
					spec: {
						description: "SubscriptionSpec defined the desired state of a AWS SNS Topic"
						properties: {
							deletionPolicy: {
								default:     "Delete"
							...
							forProvider: {
								description: "SubscriptionParameters define the desired state of a AWS SNS Topic"
								...
								properties: {
									...
									region: {
										description: "Region is the region you'd like your Subscription to be in."
									...
									topicArnSelector: {
										description: "TopicArnSelector selects a reference to a SNS Topic and retrieves its TopicArn"
					...
					status: {
						description: "SubscriptionStatus is the status of AWS SNS Topic"
						properties: {
							atProvider: {
								description: "SubscriptionObservation represents the observed state of a AWS SNS Topic"

								properties: {
									confirmationWasAuthenticated: {
										description: "ConfirmationWasAuthenticated – true if the subscription confirmation request was authenticated."
