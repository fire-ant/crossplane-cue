package cognitoidentityprovider_aws_crossplane_io_userpooldomains

customresourcedefinition: "userpooldomains.cognitoidentityprovider.aws.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "UserPoolDomain is the Schema for the UserPoolDomains API"
				properties: {
					apiVersion: {
					...
					spec: {
						description: "UserPoolDomainSpec defines the desired state of UserPoolDomain"
						properties: {
							deletionPolicy: {
								default:     "Delete"
							...
							forProvider: {
								description: "UserPoolDomainParameters defines the desired state of UserPoolDomain"
		...
		"""
									...
									region: {
										description: "Region is which region the UserPoolDomain will be created."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "UserPoolDomainObservation defines the observed state of UserPoolDomain"
