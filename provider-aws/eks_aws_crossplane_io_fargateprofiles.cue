package eks_aws_crossplane_io_fargateprofiles

customresourcedefinition: "fargateprofiles.eks.aws.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "A FargateProfile is a managed resource that represents an AWS Elastic Kubernetes Service FargateProfile. Deprecated: Please use v1beta1 version of this resource."
				...
				properties: {
					...
					spec: {
						description: "A FargateProfileSpec defines the desired state of an EKS FargateProfile."
						...
						properties: {
							...
							forProvider: {
								description: "FargateProfileParameters define the desired state of an AWS Elastic Kubernetes Service FargateProfile. All fields are immutable as it is not possible to update a Fargate profile."
		...
		"""
									...
									podExecutionRoleArnRef: {
										description: "PodExecutionRoleArnRef is a reference to an IAMRole used to set the PodExecutionRoleArn. At least one of podExecutionRoleArn, podExecutionRoleArnRef or podExecutionRoleArnSelector has to be given"
									...
									podExecutionRoleArnSelector: {
										description: "PodExecutionRoleArnSelector selects references to IAMRole used to set the PodExecutionRoleArn. At least one of podExecutionRoleArn, podExecutionRoleArnRef or podExecutionRoleArnSelector has to be given"
									...
									region: {
										description: "Region is the region you'd like  the FargateProfile to be created in."
									...
									selectors: {
										...
										items: {
											description: "FargateProfileSelector is an object representing an AWS Fargate profile selector."
					...
					status: {
						description: "A FargateProfileStatus represents the observed state of an EKS FargateProfile."

						properties: {
							atProvider: {
								description: "FargateProfileObservation is the observed state of a FargateProfile."
			...
			name: "v1beta1"
			schema: openAPIV3Schema: {
				description: "A FargateProfile is a managed resource that represents an AWS Elastic Kubernetes Service FargateProfile."
