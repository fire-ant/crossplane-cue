package opensearchservice_aws_crossplane_io_domains

customresourcedefinition: "domains.opensearchservice.aws.crossplane.io": {
							...
							forProvider: {
								...
								properties: {
									...
									advancedSecurityOptions: {
										...
										properties: {
											anonymousAuthEnabled: type: "boolean"
												...
												properties: {
													...
													idp: {
														...
														properties: {
															...
															metadataContent: type: "string"
														}
														type: "object"
													}
													masterBackendRole: type: "string"
													masterUserName: type: "string"
									...
									autoTuneOptions: {
										...
										properties: {
											...
											maintenanceSchedules: {
												items: {
													properties: {
														cronExpressionForRecurrence: type: "string"
														duration: {
									...
									clusterConfig: {
										...
										properties: {
											...
											dedicatedMasterType: type: "string"
											instanceCount: {
												format: "int64"
												type:   "integer"
											}
									...
									domainEndpointOptions: {
										...
										properties: {
											...
											customEndpointEnabled: type: "boolean"
											enforceHTTPS: type: "boolean"
											tlsSecurityPolicy: type: "string"
										}
										type: "object"
									}
									ebsOptions: {
										...
										properties: {
											...
											volumeType: {
												description: "The type of EBS volume, standard, gp2, or io1. See Configuring EBS-based Storage (http://docs.aws.amazon.com/opensearch-service/latest/developerguide/opensearch-createupdatedomains.html#opensearch-createdomain-configure-ebs) for more information."
					...
					status: {
						...
						properties: {
							atProvider: {
								...
								properties: {
									arn: {
										description: "The Amazon Resource Name (ARN) of a domain. See IAM identifiers (https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_identifiers.html) in the AWS Identity and Access Management User Guide for more information."
									...
									serviceSoftwareOptions: {
										...
										properties: {
											...
											optionalDeployment: type: "boolean"
									...
									snapshotOptions: {
										...
										properties: automatedSnapshotStartHour: {
											format: "int64"
											type:   "integer"
										}
										type: "object"
