package elasticache_aws_crossplane_io_cacheparametergroups

customresourcedefinition: "cacheparametergroups.elasticache.aws.crossplane.io": {
	...
	spec: {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "CacheParameterGroupParameters defines the desired state of CacheParameterGroup"
		...
		"""
									...
									parameters: {
										description: "A list of parameters to associate with this DB parameter group"
									...
									region: {
										description: "Region is which region the CacheParameterGroup will be created."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "CacheParameterGroupObservation defines the observed state of CacheParameterGroup"
