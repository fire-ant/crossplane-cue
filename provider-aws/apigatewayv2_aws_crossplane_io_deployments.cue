package apigatewayv2_aws_crossplane_io_deployments

customresourcedefinition: "deployments.apigatewayv2.aws.crossplane.io": {
						...
						properties: {
							...
							forProvider: {
								...
								properties: {
									...
									stageNameRef: {
										description: "StageNameRef is a reference to an Stage used to set the StageName."
									...
									stageNameSelector: {
										description: "StageNameSelector selects references to Stage used to set the StageName."
