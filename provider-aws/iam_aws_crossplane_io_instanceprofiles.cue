package iam_aws_crossplane_io_instanceprofiles

customresourcedefinition: "instanceprofiles.iam.aws.crossplane.io": {
	...
	spec: {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "InstanceProfileParameters defines the desired state of InstanceProfile"
		...
		"""
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "InstanceProfileObservation defines the observed state of InstanceProfile"

								properties: {
									arn: {
										description: "The Amazon Resource Name (ARN) specifying the instance profile. For more information about ARNs and how to use them in policies, see IAM identifiers (https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_Identifiers.html) in the IAM User Guide."
									...
									instanceProfileID: {
										description: "The stable and unique string identifying the instance profile. For more information about IDs, see IAM identifiers (https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_Identifiers.html) in the IAM User Guide."
		...
		"""
												...
												assumeRolePolicyDocument: type: "string"
												createDate: {
													format: "date-time"
													type:   "string"
												}
