package ec2_aws_crossplane_io_vpccidrblocks

customresourcedefinition: "vpccidrblocks.ec2.aws.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "A VPCCIDRBlock is a managed resource that represents an secondary CIDR block for a VPC Deprecated: Please use v1beta1 version of this resource."
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "VPCCIDRBlockParameters define the desired state of an VPC CIDR Block"
		...
		"""
									...
									region: {
										description: "Region is the region you'd like your VPC CIDR to be created in."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "VPCCIDRBlockObservation keeps the state for the external resource"
			...
			name: "v1beta1"
			schema: openAPIV3Schema: {
				description: "A VPCCIDRBlock is a managed resource that represents an secondary CIDR block for a VPC"
