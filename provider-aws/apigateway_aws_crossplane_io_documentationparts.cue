package apigateway_aws_crossplane_io_documentationparts

customresourcedefinition: "documentationparts.apigateway.aws.crossplane.io": {
	...
	spec: {
		...
		names: {
			...
			listKind: "DocumentationPartList"
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "DocumentationPart is the Schema for the DocumentationParts API"
				properties: {
					apiVersion: {
					...
					spec: {
						description: "DocumentationPartSpec defines the desired state of DocumentationPart"
						properties: {
							deletionPolicy: {
								default:     "Delete"
							...
							forProvider: {
								description: "DocumentationPartParameters defines the desired state of DocumentationPart"
								...
								properties: {
									...
									region: {
										description: "Region is which region the DocumentationPart will be created."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "DocumentationPartObservation defines the observed state of DocumentationPart"
