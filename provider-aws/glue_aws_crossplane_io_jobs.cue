package glue_aws_crossplane_io_jobs

customresourcedefinition: "jobs.glue.aws.crossplane.io": {
	...
	spec: {
		...
		"""
									...
									connectionRefs: {
										description: "ConnectionRefs is a list of references to Connections used to set the Connections."
									...
									connectionSelector: {
										description: "ConnectionsSelector selects references to Connections used to set the Connections."
		...
		"""
									...
									role: {
										description: "The name or Amazon Resource Name (ARN) of the IAM role associated with this job. Role is a required field"
									...
									securityConfigurationRef: {
										description: "SecurityConfigurationRef is a reference to an SecurityConfiguration used to set the SecurityConfiguration."
									...
									securityConfigurationSelector: {
										description: "SecurityConfigurationSelector selects references to SecurityConfiguration used to set the SecurityConfiguration."
									...
									tags: {
										additionalProperties: type: "string"
										description: "The tags to use with this job. You may use tags to limit access to the job. For more information about tags in Glue, see Amazon Web Services Tags in Glue (https://docs.aws.amazon.com/glue/latest/dg/monitor-tags.html) in the developer guide."
