package prometheusservice_aws_crossplane_io_rulegroupsnamespaces

customresourcedefinition: "rulegroupsnamespaces.prometheusservice.aws.crossplane.io": {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "RuleGroupsNamespaceParameters defines the desired state of RuleGroupsNamespace"
								...
								properties: {
									...
									region: {
										description: "Region is which region the RuleGroupsNamespace will be created."
					...
					status: {
						...
						properties: {
							atProvider: {
								description: "RuleGroupsNamespaceObservation defines the observed state of RuleGroupsNamespace"
