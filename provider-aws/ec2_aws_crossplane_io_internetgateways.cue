package ec2_aws_crossplane_io_internetgateways

customresourcedefinition: "internetgateways.ec2.aws.crossplane.io": {
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: "An InternetGateway is a managed resource that represents an AWS VPC Internet Gateway."
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							forProvider: {
								description: "InternetGatewayParameters define the desired state of an AWS VPC Internet Gateway."
					...
					status: {
						description: "An InternetGatewayStatus represents the observed state of an InternetGateway."

						properties: {
							atProvider: {
								description: "InternetGatewayObservation keeps the state for the external resource"

								properties: {
									attachments: {
										description: "Any VPCs attached to the internet gateway."
										items: {
											description: "InternetGatewayAttachment describes the attachment of a VPC to an internet gateway or an egress-only internet gateway."
